...
Original file is located at
    https://colab.research.google.com/drive/1oDrCL3IS-ecl_YjTgybyo9LX2GsJaaR7
"""
...
param_grid = {
    ...
    'svc__C': [1, 1e1, 1e2, 1e3, 1e4, 1e5],

    # # RBF kernel width => large = very local influence (overfit risk), small = broad influence (underfit risk)
    'svc__gamma': [1e-1, 1e-3, 1e-5, 1e-7],
}

# https://scikit-learn.org/stable/modules/generated/sklearn.pipeline.Pipeline.html
pipe = Pipeline([
    ("scaler", StandardScaler()), # scalar to scale data to have mean 0 and std=1
    ("svc", SVC(kernel='rbf', probability=True)) # SVM for classifiction, using rbf kernel
])
